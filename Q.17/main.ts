...
let anotherGuest : string = "Friends"
...
let moreGuests : string = "Found a bigger dinner table"
...
let changingPlan : string = "I am able to invite only two people for dinner."
...
let lastMessage : string = "Removed all the guests from the array as here you can see an empty array ===>"
